...
output_file_path = rospkg.RosPack().get_path('airmate_navigation')+"/saved_path/pose.csv"
waypoints = []
dust_density = 0.

def set_dust(data):
    global dust_density
    dust_density= (data.data)
...
class FollowPath(State):
    def __init__(self):
        ...
        self.get_dust = rospy.Subscriber('dust_density', Float32, set_dust)
...
def main():
    rospy.init_node('airmate_navigation')
