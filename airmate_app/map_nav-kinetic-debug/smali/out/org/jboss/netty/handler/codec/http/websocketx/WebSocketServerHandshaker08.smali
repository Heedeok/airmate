.class public Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketServerHandshaker08;
...
.method static constructor <clinit>()V
    ...
    .line 49
    const-class v0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketServerHandshaker08;

    invoke-static {v0}, Lorg/jboss/netty/logging/InternalLoggerFactory;->getInstance(Ljava/lang/Class;)Lorg/jboss/netty/logging/InternalLogger;

    move-result-object v0

    sput-object v0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketServerHandshaker08;->logger:Lorg/jboss/netty/logging/InternalLogger;
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;ZJ)V
    ...
    .line 87
    iput-boolean p3, p0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketServerHandshaker08;->allowExtensions:Z
...
.method public handshake(Lorg/jboss/netty/channel/Channel;Lorg/jboss/netty/handler/codec/http/HttpRequest;)Lorg/jboss/netty/channel/ChannelFuture;
    ...
    sget-object v0, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketServerHandshaker08;->logger:Lorg/jboss/netty/logging/InternalLogger;
    ...
    const-string v6, "Channel %s WS Version 8 server handshake"
    ...
    sget-object v10, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketServerHandshaker08;->logger:Lorg/jboss/netty/logging/InternalLogger;
    ...
    const-string v11, "WS Version 8 Server Handshake key: %s. Response: %s."
    ...
    .line 161
    invoke-virtual {v1, v10}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketServerHandshaker08;->selectSubprotocol(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 166
    invoke-virtual {v1, v11}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketServerHandshaker08;->setSelectedSubprotocol(Ljava/lang/String;)V
    ...
    new-instance v15, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocket08FrameDecoder;

    iget-boolean v4, v1, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketServerHandshaker08;->allowExtensions:Z

    move-object/from16 v16, v0

    .end local v0    # "sha1":[B
    .local v16, "sha1":[B
    invoke-virtual/range {p0 .. p0}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocketServerHandshaker08;->getMaxFramePayloadLength()J

    move-result-wide v0

    invoke-direct {v15, v5, v4, v0, v1}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocket08FrameDecoder;-><init>(ZZJ)V
    ...
    new-instance v4, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocket08FrameEncoder;

    const/4 v5, 0x0

    invoke-direct {v4, v5}, Lorg/jboss/netty/handler/codec/http/websocketx/WebSocket08FrameEncoder;-><init>(Z)V
