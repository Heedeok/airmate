...
.method static isOrderedMap(Ljava/util/Map;)Z
    ...
    .line 330
    .local v1, "mapType":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    ...
    :try_end_39
    .catch Ljava/lang/Exception; {:try_start_33 .. :try_end_39} :catch_7b
    ...
    .line 362
    .local v3, "expectedKeys":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    const-string v6, "dummyValue"

    .line 363
    .local v6, "dummyValue":Ljava/lang/String;
    ...
    .line 370
    .local v14, "actualKey":Ljava/lang/Object;
    ...
    .line 374
    .end local v14    # "actualKey":Ljava/lang/Object;
    :cond_76
    goto :goto_5f

    .line 363
    .end local v10    # "element":S
    ...
    .end local v6    # "dummyValue":Ljava/lang/String;
    .local v3, "newMap":Ljava/util/Map;
    :catch_7b
    move-exception v0
...
.method public setPipelineAsMap(Ljava/util/Map;)V
    ...
    :cond_30
    invoke-virtual {p0, v0}, Lorg/jboss/netty/bootstrap/Bootstrap;->setPipeline(Lorg/jboss/netty/channel/ChannelPipeline;)V
