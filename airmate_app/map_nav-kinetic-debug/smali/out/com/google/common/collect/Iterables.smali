...
.method public static contains(Ljava/lang/Iterable;Ljava/lang/Object;)Z
    ...
    move-result v2
    :try_end_c
    .catch Ljava/lang/NullPointerException; {:try_start_8 .. :try_end_c} :catch_f
...
.method public static get(Ljava/lang/Iterable;ILjava/lang/Object;)Ljava/lang/Object;
    ...
    move-result-object v0
    :try_end_a
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_6 .. :try_end_a} :catch_b
...
.method public static getLast(Ljava/lang/Iterable;)Ljava/lang/Object;
    ...
    .line 809
    .local v0, "sortedSet":Ljava/util/SortedSet;, "Ljava/util/SortedSet<TT;>;"
    ...
    .line 812
    .end local v0    # "sortedSet":Ljava/util/SortedSet;, "Ljava/util/SortedSet<TT;>;"
    :cond_24
    invoke-interface {p0}, Ljava/lang/Iterable;->iterator()Ljava/util/Iterator;
...
.method private static removeIfFromRandomAccessList(Ljava/util/List;Lcom/google/common/base/Predicate;)Z
    ...
    :try_end_1a
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_17 .. :try_end_1a} :catch_1b
